"""
Ultra-aggressive batch inference on DRadDataset/testing without ImageSets dependency.
Uses stricter NMS and threshold settings to maximize precision and minimize false positives.
"""
...
def parse_configs():
    ...
    if cfg.output_dir is None:
        cfg.output_dir = os.path.join(cfg.root_dir, '超激进P')
...
def main():
    ...
    print('\n' + '='*80)
    print('ULTRA-AGGRESSIVE NMS INFERENCE MODE')
    print('='*80)
